...
void UpdateFrame(void)
{
	...
	SetColor(50, 50, 50);
	DrawLine(10, 10, 800, 800);
	DrawBox(80, 20, 639, 479);
//	FillBox(80, 20, 639, 479);
...
void PutNumber(int x, int y, const char* text, int number)
{
	char string[128];
...
void PutNumber(int x, int y, const char* text, UINT number)
{
	char string[128];
...
void PutNumber(int x, int y, const char* text, float number)
{
	char string[128];
...
void PutNumberHex(int x, int y, const char* text, int number)
{
	char string[128];
